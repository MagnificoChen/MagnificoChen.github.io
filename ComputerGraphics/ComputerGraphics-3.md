...
![图 7-1](./cg-images/7/7-1.png "左：正交投影下的线框  中：透视投影下的线框   右：透视投影、移除被遮挡线的线框")
...
![图 7-2](./cg-images/7/7-2.png "不同阶段的坐标系和变换有不同的名字")
...
![图 7-3](./cg-images/7/7-3.png "标准立方体是一个立方体，中心为原点，长度为2")
...
![图 7-4](./cg-images/7/7-4.png "正交投影立方体")
![图 7-5](./cg-images/7/7-5.png "正交投影的视体沿着-z轴方向，这样的话n和f有正确的大小关系。")
...
![图 7-6](./cg-images/7/7-6.png "用户指定一个眼睛位置e，视角方向g，向上向量t。这样我们能建立一个右手系，它的w向量和视角方向相反；v与g、t共面。")
![图 7-7](./cg-images/7/7-7.png "对于任意视角，我们需要将点存储与合适的参考系中。这个例子里用的是uvw坐标系统。")
...
![图 7-8](./cg-images/7/7-8.png "摄像机在e，视角方向是g，也就是-z轴，视平面距离为d。")
![图 7-9](./cg-images/7/7-9.png "透视投影将一个轴方向转换成一个等腰梯形，保留了直线，但不保留平行性质。")
...
![图 7-12](./cg-images/7/7-12.png "透视投影让近平面不变，放大远平面")
![图 7-13](./cg-images/7/7-13.png)
...
![图 8-1](./cg-images/8/8-1.png "图形管线的步骤")
...
![图 8-2](./cg-images/8/8-2.png "三种看上去合理的画线法") ![图 8-3](./cg-images/8/8-3.png "判断上下哪个像素应该着色")
...
![图 8-5](./cg-images/8/8-5.png) ![图 8-6](./cg-images/8/8-6.png "离屏点会在非共享边界的两点中的某一点侧。")
...
![图 8-7](./cg-images/8/8-7.png "深度z现在通过投影变换转换为z'")
...
![图 8-9](./cg-images/8/8-9.png)
![图 8-10](./cg-images/8/8-10.png "由于近大远小，它们两个单位球看上去不一样大。但渲染顺序错误。")
...
![图 8-13](./cg-images/8/8-13.png "高若德着色，也即逐顶点着色")
![图 8-14](./cg-images/8/8-14.png "冯着色，也即逐片元着色")
...
![图 8-15](./cg-images/8/8-15.png "近距离观察抗锯齿前后的两条直线")
